...
import { buildLocalTaskStatusOptions, AssigneePicker, DatesPicker, LocalTaskDetailModal, PriorityPicker, StatusPicker } from './local-list-task-surface';
...
export function LocalTableTaskSurface({ tasks, statusGroups, statusOverrides, onUpdateTask }: LocalTableTaskSurfaceProps) {
