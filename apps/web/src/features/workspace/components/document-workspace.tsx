...
import { exportDocx, importDocx } from '../lib/document-file';
...
export function DocumentWorkspace() {
  ...
  const selectedSpace = spaces.find((space) => space.id === query.get('space')) ?? spaces[0];
